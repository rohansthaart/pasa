...
import { Description, MoneyOutlined } from "@material-ui/icons";
...
{selectedProduct.image.map(product=><li className="" style={{display:'inline'}}>
           ...
           <form className=''>
             ...
             <button className='btn ' onClick='submit'>submit</button>
              ...
              <Reviews
                ...
                review='this is perfect product'
